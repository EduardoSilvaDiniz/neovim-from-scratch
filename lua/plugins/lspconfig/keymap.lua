...
return {
	...
	{ "<leader>gd", telescopeBuiltin.lsp_definitions, desc = "LSP: " .. "[G]oto [D]efinition" },
	{ "<leader>gr", telescopeBuiltin.lsp_references, desc = "LSP: " .. "[G]oto [R]eferences" },
	{ "<leader>gI", telescopeBuiltin.lsp_implementations, desc = "LSP: " .. "[G]oto [I]mplementation" },
